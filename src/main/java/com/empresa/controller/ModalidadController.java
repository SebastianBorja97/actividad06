...
public class ModalidadController {
	...
	@GetMapping("/porIdModalidadSedeIdDeporteConJson")
	@ResponseBody
	public ResponseEntity<Map<String, Object>> listaPorIdModaSedeIdDeporteConParametros(
							@RequestBody FiltroModalidad moda) {
		
		Map<String, Object> salida = new HashMap<String, Object>();
		try {
			moda.setSede("%"+moda.getSede()+"%");
			List<Modalidad> lista = modalidadService.listaPorFiltroJSON(moda);
